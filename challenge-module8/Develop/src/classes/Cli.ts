...
class Cli {
  // Vehicles property accepts Truck and Motorbike objects as well by using union operator
      ...
      .prompt([
        {
          ...
          // Choices array includes Car, Truck and Motorbike
      ...
      .then((answers) => {
        switch (answers.vehicleType) {
          ...
          case "Motorbike":
            ...
            break;
          default:
            console.log("Unknown vehicle type selected");
            break;
        }
      });
  }
    ...
    inquirer
      ...
      .then((answers) => {
        const truck = new Truck(
          //  generateVin method is static and should be called using the class name Cli, make sure to use Cli.generateVin() for creating a truck and motorbike as well!
          Cli.generateVin(),
          answers.color,
          answers.make,
          answers.model,
